...
module.exports = {
   ...
   */
  adapters: {
    ClientsController: require('./adapters/clients-controller'),
  },
  ports: {
    ClientRegistration: require('./ports/client-registration'),
  },
  repositories: {
    ClientRepository: require('./repositories/client-repository'),
  },
};
