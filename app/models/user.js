...
let UserSchema = new Schema({
  ...
  confirmationToken: { type: String, required: 'Confirmation token required', unique: 'Confirmation token must be unique' },
...
/**
 * Authenticate user by comparing a hashed version of the password with the stored
 * version
 */
